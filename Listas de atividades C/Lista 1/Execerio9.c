...
//informa o número de meses que ira durar a aplicação
    printf("\n Informe o numero de meses da aplicaçao: ");
    scanf("%d", &num_meses);
//formula para cálcular do valor total acumulado e dos juros rendidos utilizando as fórmulas de juros compostos
